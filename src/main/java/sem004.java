...
public class sem004 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Введите ФИО, возраст, пол через пробел, q - для выхода: ");
        ...
        while (true){
            System.out.println("Введите sort - для вывода сортированного по возрасту списка, q - для выхода: ");
            String input = scn.nextLine();
            if (input.equals("sort")){
                ...
                for (int i: index) {
                    StringBuilder str = new StringBuilder();
                    str.append(lastName.get(i)).append(" ").append(firstName.get(i)).append(" ").append(patronymic.get(i)).append(" ").append(age.get(i)).append(" ").append(gender.get(i));
                    System.out.println(str);
                }
